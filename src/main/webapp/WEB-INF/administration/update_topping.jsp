...
<form class="main" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="input-field col s12">
            <input readonly type="number" name="id" id="id" value="${topping.getId()}">
    ...
    <div class="row">
        <p>
            <input name="active" type="radio" value="true" id="active-true" ${topping.isActive() ? 'checked' : ''}/>
            <label for="active-true">Active</label>
        </p>
        <p>
            <input name="active" type="radio" value="false" id="active-false" ${topping.isActive() ? '' : 'checked'}/>
